...
public class HuevoSorpresaHachaHachaHector2122 {
    ...
    private double precio_maxHachaHachaHector2122;//precio máximo que puede tener un huevo sorpresa

    /*Constructor por defecto*/
    public HuevoSorpresaHachaHachaHector2122() {
    }


    /*Constructor por parámetros*/
    public HuevoSorpresaHachaHachaHector2122(int unidades, double precio, String sorpresa, double precio_max) {
        this.unidades = unidades;
        this.precio = precio;
        this.sorpresa = sorpresa;
        this.precio_maxHachaHachaHector2122 = precio_max;
    }
...
suficientes unidades en la tienda*/
    public void sacarHuevosSorpresas(int unidades, double dinero, String sorpresaHachaHachaHector2122) throws Exception {
        if (dinero <= 0) {
    ...
    public void aumentarPrecio(double aumento) throws Exception {
        ...
        if (getPrecio_maxHachaHachaHector2122() < getPrecio() + aumento) {
    ...
    /**
     * @return the precio_maxHachaHachaHector2122
     */
    public double getPrecio_maxHachaHachaHector2122() {
        return precio_maxHachaHachaHector2122;
    }

    /**
     * @param precio_maxHachaHachaHector2122 the precio_maxHachaHachaHector2122 to set
     */
    public void setPrecio_maxHachaHachaHector2122(double precio_maxHachaHachaHector2122) {
        this.precio_maxHachaHachaHector2122 = precio_maxHachaHachaHector2122;
    }
}
