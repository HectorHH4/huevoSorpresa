...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HuevoSorpresaHachaHachaHector2122 h_sorpresa;
       
        
        h_sorpresa=new HuevoSorpresaHachaHachaHector2122(10,5,"peluche",10);
        opera_PrecioHachaHachaHector2122(h_sorpresa);
        
        opera_UnidadesHachaHachaHector2122(h_sorpresa);
        
    }

    public static void opera_UnidadesHachaHachaHector2122(HuevoSorpresaHachaHachaHector2122 h_sorpresa) {
    ...
    public static void opera_PrecioHachaHachaHector2122(HuevoSorpresaHachaHachaHector2122 h_sorpresa) {
